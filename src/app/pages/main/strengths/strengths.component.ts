...
//     desc: 'Наши профессионалы подберут вам интсрумент исходя исключительно из ваших предпочтений и финансовых возможностей.',
//     img: '/assets/img/strengths/strengths1-.jpg',
//     thumb: '/assets/img/strengths/strengths1-.jpg',
//   },
//   {
//     title: 'Мы серьезно относимся к работе',
//     desc: 'каждый клиент для нас, как член семьи. Мы надеемся, что вы не раз обратитесь к нам и порекомендуете нас друзьям.',
//     img: '/assets/img/strengths/strengths2-.jpg',
//     thumb: '/assets/img/strengths/strengths2-.jpg',
//   },
//   {
//     title: 'Только оригинальные и качественные инструменты',
//     desc: 'Мы работаем только с оффициальными поставщиками и ручаемся за каждый товар. Все инструменты проходят контроль качества.',
//     img: '/assets/img/strengths/strengths3-.jpg',
//     thumb: '/assets/img/strengths/strengths3-.jpg',
//   },
//   {
//     title: 'Лучшее звучание',
//     desc: 'Только лучшие породы дерева, дорогие металы. Все это создает невероятное звучание, которое пораизит ваш тонкий слух',
